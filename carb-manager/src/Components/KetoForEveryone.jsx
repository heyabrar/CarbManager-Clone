...
export default function KetoForEveryone( ){
    return (
       ...
       <div>
           ...
           <div className="KFE-List">
           <List spacing={3}>
                <ListItem><ListIcon as={SiCodechef} color='green.500' fontSize={'18px'}/>Save time with automatic meal plans and grocery lists tailored <p style={{marginLeft:'25px'}}>to specific food preferences and allergies</p></ListItem>
                ...
                <ListItem><ListIcon as={GiKitchenScale} color='green.500' fontSize={'18px'}/>Have fun tracking the macros and micros of over 1 million foods <p style={{marginLeft:'25px'}}>with cutting-edge features, like our popular Snap Foods feature that uses photo recognition technology</p></ListItem>
            </List>
           </div>
        </div>
